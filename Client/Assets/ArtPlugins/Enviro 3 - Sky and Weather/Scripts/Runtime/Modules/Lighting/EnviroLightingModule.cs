...
namespace Enviro
{
    ...
    public class EnviroLighting
    {
        ...
        //自定义开始
        public Color lighingSunColorTint = Color.white;
        public Color lighingMoonColorTint = Color.white; 
        //自定义结束
        ...
        public void UpdateDirectLighting ()
        {
            if(Settings.lightingMode == EnviroLighting.LightingMode.Single)
            {
                if(!EnviroManager.instance.isNight)
                {
                    ...
                    //自定义开始
                    EnviroManager.instance.Objects.directionalLight.color = Settings.sunColorGradient.Evaluate(EnviroManager.instance.solarTime) * Settings.lighingSunColorTint;
                    //自定义结束
                }
                else
                {
                    ...
                    //自定义开始
                    EnviroManager.instance.Objects.directionalLight.color = Settings.moonColorGradient.Evaluate(EnviroManager.instance.lunarTime) * Settings.lighingMoonColorTint;
                    //自定义结束;
                }
            }
            else
