...
{  
    ...
    public class EnviroCloudGlobalSettings 
    {
        ...
        //自定义开始
        public Color cloudsSunColorTint = Color.white;
        public Color cloudsMoonColorTint = Color.white;
        public Color cloudsAmbientColorTint = Color.white;
        //自定义结束
    ...
    {   
        ...
        void SetBlendShader (Camera cam, EnviroVolumetricCloudRenderer renderer)
        {
            ...
            if(!EnviroManager.instance.isNight)
            {
                ...
                //自定义开始
                directLightColor = settingsGlobal.sunLightColorGradient.Evaluate(EnviroManager.instance.solarTime) * settingsGlobal.cloudsSunColorTint;
                //自定义结束
            }
            else
            { 
                ...
                //自定义开始
                directLightColor = settingsGlobal.moonLightColorGradient.Evaluate(EnviroManager.instance.lunarTime) * settingsGlobal.cloudsMoonColorTint;
                //自定义结束
            }
            ...
            //自定义开始
            renderer.blendAndLightingMat.SetColor("_AmbientColor", settingsGlobal.ambientColorGradient.Evaluate(EnviroManager.instance.solarTime) * settingsGlobal.ambientLighIntensity * settingsGlobal.cloudsAmbientColorTint);
            //自定义结束
