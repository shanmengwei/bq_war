...
namespace Enviro
{
    ...
    {  
        ...
        private void BlendSkyOverride(float blendTime)
        {
            ...
            if(sky != null) 
            {
                sky.Settings.skySunColorTint = Color.Lerp(sky.Settings.skySunColorTint, targetWeatherType.skyOverride.skySunColorTint,blendTime);
                sky.Settings.skyMoonColorTint = Color.Lerp(sky.Settings.skyMoonColorTint, targetWeatherType.skyOverride.skyMoonColorTint,blendTime);
                sky.Settings.skyIntensity = Mathf.Lerp(sky.Settings.skyIntensity, targetWeatherType.skyOverride.skyIntensity,blendTime);
            }
        }
        //自定义结束
        ...
        private void BlendLightingOverride(float blendTime)
        {
            ...
            {
                //自定义开始
                lighting.Settings.lighingSunColorTint = Color.Lerp(lighting.Settings.lighingSunColorTint, targetWeatherType.lightingOverride.lighingSunColorTint,blendTime);
                lighting.Settings.lighingMoonColorTint = Color.Lerp(lighting.Settings.lighingMoonColorTint, targetWeatherType.lightingOverride.lighingMoonColorTint,blendTime);
                //自定义结束
        ...
        private void BlendVolumetricCloudsOverride(float blendTime)
        {
            ...
            {   
                ...
                //自定义开始
                clouds.settingsGlobal.cloudsSunColorTint = Color.Lerp(clouds.settingsGlobal.cloudsSunColorTint, targetWeatherType.cloudsOverride.cloudsSunColorTint,blendTime);
                clouds.settingsGlobal.cloudsMoonColorTint = Color.Lerp(clouds.settingsGlobal.cloudsMoonColorTint, targetWeatherType.cloudsOverride.cloudsMoonColorTint,blendTime);
                clouds.settingsGlobal.cloudsAmbientColorTint = Color.Lerp(clouds.settingsGlobal.cloudsAmbientColorTint, targetWeatherType.cloudsOverride.cloudsAmbientColorTint,blendTime);
                //自定义结束
        ...
        private void BlendFlatCloudsOverride(float blendTime)
        {
            ...
            if(flatClouds != null)
            {
                ...
                //自定义开始
                flatClouds.settings.cirrusColorTint = Color.Lerp(flatClouds.settings.cirrusColorTint, targetWeatherType.flatCloudsOverride.cirrusColorTint,blendTime);
                //自定义结束    
            }
        }
