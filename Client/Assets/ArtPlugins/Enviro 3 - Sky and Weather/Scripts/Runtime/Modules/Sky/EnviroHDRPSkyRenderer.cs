...
namespace UnityEngine.Rendering.HighDefinition  
{
    class EnviroHDRPSkyRenderer : SkyRenderer
    {
        ...
        public override void RenderSky(BuiltinSkyParameters builtinParams, bool renderForCubemap, bool renderSunDisk)
        {
            ...
            if(builtinParams.hdCamera.camera.cameraType != CameraType.SceneView && Enviro.EnviroManager.instance.Camera != null && builtinParams.hdCamera.camera != Enviro.EnviroManager.instance.Camera && renderForCubemap)
            {
                return;
            }
