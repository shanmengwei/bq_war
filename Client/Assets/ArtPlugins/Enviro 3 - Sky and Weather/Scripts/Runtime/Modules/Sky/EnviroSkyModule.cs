...
namespace Enviro
{
    ...
    public class EnviroSky
    {
        ...
        //自定义开始
        public Color skySunColorTint = Color.white;
        public Color skyMoonColorTint = Color.white;
    ...
    {  
        ...
        public void UpdateSkybox (Material mat)
        {
            ...
            //自定义开始
            Shader.SetGlobalColor("_SunColor",Settings.sunDiscColorGradient.Evaluate(solarTime) * Settings.skySunColorTint);
            mat.SetColor("_MoonColor",Settings.moonColorGradient.Evaluate(solarTime) * Settings.skyMoonColorTint);
            Shader.SetGlobalFloat("_Intensity", Settings.intensity * Settings.intensityCurve.Evaluate(solarTime) * Settings.skyIntensity);
            //自定义结束
