...
namespace Enviro
{
    ...
    {  
        ...
        //自定义开始
        private SerializedProperty cirrusColorTint;
        //自定义结束
        //Properties Cirrus
        ...
        public override void OnEnable()
        {
            ...
            //自定义开始
            cirrusColorTint = serializedObj.FindProperty("settings.cirrusColorTint");
            //自定义结束
        ...
        public override void OnInspectorGUI()
        {
            ...
            { 
                ...
                if(myTarget.showCirrusCloudsControls)
                {
                    ...
                    //自定义开始
                    DisableInputStart();
                    EditorGUILayout.PropertyField(cirrusColorTint);
                    DisableInputEnd(); 
                    //自定义结束
                    GUILayout.Space(5);
