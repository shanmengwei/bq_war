...
namespace Enviro
{
    ...
    {  
        ...
        //自定义开始
        private SerializedProperty skyTransitionSpeed;
        //自定义结束  
                    ...
                    {      
                          ...
                          if(curWT == myTarget.targetWeatherType)
                            ...
                            if(curWT.showEditor)
                            {
                                ...
                                {
                                    GUILayout.Space(5);
                                    curWT.skyOverride.skySunColorTint = EditorGUILayout.ColorField("Sun Color Tint", curWT.skyOverride.skySunColorTint);
                                    curWT.skyOverride.skyMoonColorTint = EditorGUILayout.ColorField("Moon Color Tint", curWT.skyOverride.skyMoonColorTint);
                                    curWT.skyOverride.skyIntensity = EditorGUILayout.Slider("Sky Intensity", curWT.skyOverride.skyIntensity,0f,1f);
                                }
                                ...
                                if(curWT.showLightingControls)
                                {
                                    GUILayout.Space(5);
                                    //自定义开始
                                    curWT.lightingOverride.lighingSunColorTint = EditorGUILayout.ColorField("Sun Color Tint", curWT.lightingOverride.lighingSunColorTint);
                                    curWT.lightingOverride.lighingMoonColorTint = EditorGUILayout.ColorField("Moon Color Tint", curWT.lightingOverride.lighingMoonColorTint);
                                    //自定义结束
                                ...
                                if(curWT.showCloudControls)
                                {
                                    ...
                                    if(curWT.cloudsOverride.showLayer1)
                                    {
                                        GUILayout.Space(5);
                                        //自定义开始
                                        curWT.cloudsOverride.cloudsSunColorTint = EditorGUILayout.ColorField("Sun Color Tint", curWT.cloudsOverride.cloudsSunColorTint);
                                        curWT.cloudsOverride.cloudsMoonColorTint = EditorGUILayout.ColorField("Moon Color Tint", curWT.cloudsOverride.cloudsMoonColorTint);
                                        curWT.cloudsOverride.cloudsAmbientColorTint = EditorGUILayout.ColorField("Ambient Color Tint", curWT.cloudsOverride.cloudsAmbientColorTint);
                                        //自定义结束
                                ...
                                { 
                                    GUILayout.Space(5);
                                    //自定义开始
                                    curWT.flatCloudsOverride.cirrusColorTint = EditorGUILayout.ColorField("Cirrus Color Tint", curWT.flatCloudsOverride.cirrusColorTint);
                                    //自定义结束
