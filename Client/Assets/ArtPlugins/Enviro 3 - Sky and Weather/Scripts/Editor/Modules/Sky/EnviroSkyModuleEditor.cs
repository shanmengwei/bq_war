...
namespace Enviro
{
    ...
    {  
        ...
        //自定义开始
        private SerializedProperty skySunColorTint,skyMoonColorTint,skyIntensity;
        //自定义结束
        ...
        public override void OnEnable()
        {
            ...
            //自定义开始
            skySunColorTint = serializedObj.FindProperty("Settings.skySunColorTint"); 
            skyMoonColorTint = serializedObj.FindProperty("Settings.skyMoonColorTint");
            //自定义结束
            ...
            //自定义开始
            skyIntensity = serializedObj.FindProperty("Settings.skyIntensity");
            //自定义结束
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(myTarget.showModuleInspector)
            {
                ...
                if(myTarget.showSkyControls)
                {
                    ...
                    //自定义开始
                    DisableInputStart();
                    EditorGUILayout.PropertyField(skyIntensity);
                    DisableInputEnd(); 
                    //自定义结束
                ...
                if(myTarget.showSkySunControls)
                {
                    ...
                    //自定义开始
                    DisableInputStart();
                    EditorGUILayout.PropertyField(skySunColorTint);
                    DisableInputEnd(); 
                    //自定义结束
                    GUILayout.Space(5);
                ...
                if(myTarget.showSkyMoonControls)
                {
                    ...
                    //自定义开始
                    DisableInputStart();
                    EditorGUILayout.PropertyField(skyMoonColorTint);
                    DisableInputEnd(); 
                    //自定义结束
