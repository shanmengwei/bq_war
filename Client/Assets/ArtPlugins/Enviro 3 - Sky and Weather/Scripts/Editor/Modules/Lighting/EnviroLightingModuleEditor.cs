...
namespace Enviro
{
    ...
    {  
        ...
        //自定义开始
        private SerializedProperty lighingSunColorTint, lighingMoonColorTint;
        //自定义结束
        //Properties 
        //Direct Lighting
        ...
        public override void OnEnable()
        {
            ...
            //自定义开始
            lighingSunColorTint = serializedObj.FindProperty("Settings.lighingSunColorTint");
            lighingMoonColorTint = serializedObj.FindProperty("Settings.lighingMoonColorTint");
            //自定义结束      
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(myTarget.showModuleInspector)
            {
                ...
                if(myTarget.showDirectLightingControls)
                {
                    ...
                    //自定义开始
                    DisableInputStart();
                    EditorGUILayout.PropertyField(lighingSunColorTint);
                    EditorGUILayout.PropertyField(lighingMoonColorTint);
                    DisableInputEnd(); 
                    //自定义结束
