...
namespace Enviro
{
    ...
    {  
        ...
        //自定义开始
        private SerializedProperty cloudsSunColorTint,cloudsMoonColorTint,cloudsAmbientColorTint;
        //自定义结束
        ...
        public override void OnEnable()
        {
            ...
            //自定义开始
            cloudsSunColorTint = serializedObj.FindProperty("settingsGlobal.cloudsSunColorTint");
            cloudsMoonColorTint = serializedObj.FindProperty("settingsGlobal.cloudsMoonColorTint");
            cloudsAmbientColorTint = serializedObj.FindProperty("settingsGlobal.cloudsAmbientColorTint");
            //自定义结束
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(myTarget.showModuleInspector)
            {
                ...
                { 
                    ...
                    //自定义开始
                    DisableInputStart();
                    EditorGUILayout.PropertyField(cloudsSunColorTint);
                    EditorGUILayout.PropertyField(cloudsMoonColorTint);
                    EditorGUILayout.PropertyField(cloudsAmbientColorTint);
                    DisableInputEnd(); 
                    //自定义结束
                    DisableInputStart();
