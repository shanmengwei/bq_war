...
namespace TEngine
{
    internal class TcpChannel : IDisposable
    {
        ...
        private readonly Queue<INetPackage> _sendQueue = new Queue<INetPackage>(2^14); //  → 2^14=16384
        private readonly Queue<INetPackage> _receiveQueue = new Queue<INetPackage>(2^14);
        private readonly List<INetPackage> _decodeTempList = new List<INetPackage>(2^7); //  → 2^7=128
