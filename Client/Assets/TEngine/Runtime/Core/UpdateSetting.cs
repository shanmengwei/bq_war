...
namespace TEngine
{
    ...
    public class UpdateSetting : ScriptableObject
    {
        ...
        /// HTTP服务器地址。
        /// </summary>
        public string HttpServerPath = "http://127.0.0.1:8081";
        /// <summary>
        /// 服务器地址。
        /// </summary>
        ...
        /// <summary>游戏 API 地址（Skynet HTTP，端口 8080）</summary>
        public string GetHttpServerPath() => $"http://{ServerIP}:8080";

        /// <summary>CDN 上传基础地址（Python CDN，端口 8081）</summary>
        public string GetCDNUploadBaseURL() => $"http://{ServerIP}:8081";
